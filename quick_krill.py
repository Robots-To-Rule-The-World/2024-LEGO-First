...
async def Run():
    bot.settings(600) 
    #first krill
    await bot.straight(170,Stop.HOLD)
    await bot.turn(-45,Stop.HOLD)
    await bot.straight(200,Stop.HOLD)
    await bot.turn(45,Stop.HOLD)
    await bot.straight(125,Stop.HOLD)
    await bot.turn(-10,Stop.HOLD)
    await bot.straight(150,Stop.HOLD)
    await bot.turn(-60,Stop.HOLD)
    await bot.straight(75,Stop.HOLD)
    await bot.turn(220,Stop.HOLD)
    await bot.straight(700,Stop.HOLD)
